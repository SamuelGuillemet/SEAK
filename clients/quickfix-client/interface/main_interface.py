...
from broker_quickfix_client.wrappers.enums import SideEnum, OrderTypeEnum
from broker_quickfix_client.wrappers.order_cancel_request import (
    OrderCancelRequest,
)
from broker_quickfix_client.handlers.execution_report import (
    ExecutionReportHandler,
)
from broker_quickfix_client.handlers.order_cancel_reject import (
...
class MainInterface(tk.Tk):
    def __init__(self, username, application, initiator):
        ...
        self.database_manager = DatabaseManager(
            "sqlite:///quickfix_client_database.db"
            )
        self.database_manager.set_refresh_callback(self.refresh_main_interface)
        self.username = username
        self.account_balance = self.database_manager.get_user_balance(
            self.username
            )
        self.owned_shares = self.database_manager.get_user_shares(
            self.username
            )
