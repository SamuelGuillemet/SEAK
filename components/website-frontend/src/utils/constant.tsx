...
export const tabLinks: LinksType = [
  { label: 'Mon compte', href: pages.account.index, scopes: ['user', 'admin'], icon: <PersonIcon className='h-6 w-6' /> },
  { label: 'Comptes utilisateurs', href: pages.account.users, scopes: ['admin'], icon: <ListBulletIcon className='h-6 w-6' /> }
];
