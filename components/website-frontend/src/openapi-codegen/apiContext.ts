...
import { QueryOperation } from '../openapi-codegen/apiComponents';
 ...
 */
export function useApiContext<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData, TQueryKey extends QueryKey = QueryKey>(
