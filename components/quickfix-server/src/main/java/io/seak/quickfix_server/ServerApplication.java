...
import io.seak.avro.MarketDataSubscriptionRequest;
...
import io.seak.avro.utils.Converters;
import io.seak.models.services.UserAuthenticationService;
...
public class ServerApplication extends MessageCracker implements Application {
  ...
  public void onLogout(SessionID sessionId) {
    ...
    this.orderProducer.sendMarketDataRequest(
        key,
        new io.seak.avro.MarketDataRequest(
          username,
          new ArrayList<>(),
          0,
          new ArrayList<>(),
  ...
  public void onMessage(NewOrderSingle message, SessionID sessionID)
    ...
    io.seak.avro.Side side = Converters.Side.toAvro(message.getSide());
    io.seak.avro.Type type = Converters.Type.toAvro(message.getOrdType());
  ...
  public void onMessage(OrderCancelReplaceRequest message, SessionID sessionID)
    ...
    if (type != io.seak.avro.Type.LIMIT) {
      throw new IncorrectTagValue(quickfix.field.OrdType.FIELD);
    }
  ...
  public void onMessage(MarketDataRequest message, SessionID sessionID)
    ...
    io.seak.avro.MarketDataRequest marketDataRequest =
      new io.seak.avro.MarketDataRequest(
        username,
        symbols,
        marketDepth,
