...
public class OrderBookRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5753349618358525505L;
  ...
  private pfe_broker.avro.OrderBookRequestType type;
   ...
   */
  public OrderBookRequest(pfe_broker.avro.OrderBookRequestType type, pfe_broker.avro.Order order, java.lang.CharSequence origClOrderID) {
    this.type = type;
    this.order = order;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: type = (pfe_broker.avro.OrderBookRequestType)value$; break;
    case 1: order = (pfe_broker.avro.Order)value$; break;
   ...
   */
  public pfe_broker.avro.OrderBookRequestType getType() {
    return type;
  }
   ...
   */
  public void setType(pfe_broker.avro.OrderBookRequestType value) {
    this.type = value;
  }
   ...
   */
  public static pfe_broker.avro.OrderBookRequest.Builder newBuilder() {
    return new pfe_broker.avro.OrderBookRequest.Builder();
  }
   ...
   * @return A new OrderBookRequest RecordBuilder
   */
  public static pfe_broker.avro.OrderBookRequest.Builder newBuilder(pfe_broker.avro.OrderBookRequest.Builder other) {
    if (other == null) {
      return new pfe_broker.avro.OrderBookRequest.Builder();
    } else {
      return new pfe_broker.avro.OrderBookRequest.Builder(other);
    }
  }
   ...
   * @return A new OrderBookRequest RecordBuilder
   */
  public static pfe_broker.avro.OrderBookRequest.Builder newBuilder(pfe_broker.avro.OrderBookRequest other) {
    if (other == null) {
      return new pfe_broker.avro.OrderBookRequest.Builder();
    } else {
      return new pfe_broker.avro.OrderBookRequest.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderBookRequest>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(pfe_broker.avro.OrderBookRequest.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(pfe_broker.avro.OrderBookRequest other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.OrderBookRequest.Builder setType(pfe_broker.avro.OrderBookRequestType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.OrderBookRequest.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.OrderBookRequest.Builder setOrder(pfe_broker.avro.Order value) {
    ...
    public pfe_broker.avro.OrderBookRequest.Builder setOrderBuilder(pfe_broker.avro.Order.Builder value) {
      clearOrder();
      orderBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.OrderBookRequest.Builder clearOrder() {
      order = null;
      orderBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.OrderBookRequest.Builder setOrigClOrderID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.OrderBookRequest.Builder clearOrigClOrderID() {
      origClOrderID = null;
    ...
    public OrderBookRequest build() {
      try {
        ...
        record.type = fieldSetFlags()[0] ? this.type : (pfe_broker.avro.OrderBookRequestType) defaultValue(fields()[0]);
        if (orderBuilder != null) {
          try {
          ...
          record.order = fieldSetFlags()[1] ? this.order : (pfe_broker.avro.Order) defaultValue(fields()[1]);
        }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.type = pfe_broker.avro.OrderBookRequestType.values()[in.readEnum()];
