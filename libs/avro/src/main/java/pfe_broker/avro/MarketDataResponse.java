...
public class MarketDataResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private java.util.List<pfe_broker.avro.MarketData> data;
   ...
   */
  public MarketDataResponse(java.lang.CharSequence username, java.lang.CharSequence symbol, java.util.List<pfe_broker.avro.MarketData> data, java.lang.CharSequence requestId, java.util.List<pfe_broker.avro.MarketDataEntry> marketDataEntries) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: data = (java.util.List<pfe_broker.avro.MarketData>)value$; break;
    case 3: requestId = (java.lang.CharSequence)value$; break;
    case 4: marketDataEntries = (java.util.List<pfe_broker.avro.MarketDataEntry>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<pfe_broker.avro.MarketData> getData() {
    return data;
  }
   ...
   * @param value the value to set.
   */
  public void setData(java.util.List<pfe_broker.avro.MarketData> value) {
    this.data = value;
  }
   ...
   */
  public static pfe_broker.avro.MarketDataResponse.Builder newBuilder() {
    return new pfe_broker.avro.MarketDataResponse.Builder();
  }
   ...
   * @return A new MarketDataResponse RecordBuilder
   */
  public static pfe_broker.avro.MarketDataResponse.Builder newBuilder(pfe_broker.avro.MarketDataResponse.Builder other) {
    if (other == null) {
      return new pfe_broker.avro.MarketDataResponse.Builder();
    } else {
      return new pfe_broker.avro.MarketDataResponse.Builder(other);
    }
  }
   ...
   * @return A new MarketDataResponse RecordBuilder
   */
  public static pfe_broker.avro.MarketDataResponse.Builder newBuilder(pfe_broker.avro.MarketDataResponse other) {
    if (other == null) {
      return new pfe_broker.avro.MarketDataResponse.Builder();
    } else {
      return new pfe_broker.avro.MarketDataResponse.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MarketDataResponse>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(pfe_broker.avro.MarketDataResponse.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(pfe_broker.avro.MarketDataResponse other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.username)) {
        this.username = data().deepCopy(fields()[0].schema(), other.username);
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.MarketDataResponse.Builder setUsername(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.MarketDataResponse.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.MarketDataResponse.Builder setSymbol(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.MarketDataResponse.Builder clearSymbol() {
      symbol = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.MarketDataResponse.Builder setData(java.util.List<pfe_broker.avro.MarketData> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.MarketDataResponse.Builder clearData() {
      data = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.MarketDataResponse.Builder setRequestId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.MarketDataResponse.Builder clearRequestId() {
      requestId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.MarketDataResponse.Builder setMarketDataEntries(java.util.List<pfe_broker.avro.MarketDataEntry> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfe_broker.avro.MarketDataResponse.Builder clearMarketDataEntries() {
    ...
    public MarketDataResponse build() {
      try {
        ...
        record.data = fieldSetFlags()[2] ? this.data : (java.util.List<pfe_broker.avro.MarketData>) defaultValue(fields()[2]);
        record.requestId = fieldSetFlags()[3] ? this.requestId : (java.lang.CharSequence) defaultValue(fields()[3]);
        record.marketDataEntries = fieldSetFlags()[4] ? this.marketDataEntries : (java.util.List<pfe_broker.avro.MarketDataEntry>) defaultValue(fields()[4]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (pfe_broker.avro.MarketData e0: this.data) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<pfe_broker.avro.MarketData> a0 = this.data;
      if (a0 == null) {
        a0 = new SpecificData.Array<pfe_broker.avro.MarketData>((int)size0, SCHEMA$.getField("data").schema());
        this.data = a0;
      } else a0.clear();
      SpecificData.Array<pfe_broker.avro.MarketData> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<pfe_broker.avro.MarketData>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          pfe_broker.avro.MarketData e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new pfe_broker.avro.MarketData();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
