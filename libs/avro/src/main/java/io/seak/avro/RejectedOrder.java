...
public class RejectedOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private io.seak.avro.OrderRejectReason reason;
   ...
   */
  public RejectedOrder(io.seak.avro.Order order, io.seak.avro.OrderRejectReason reason) {
    this.order = order;
    this.reason = reason;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: order = (io.seak.avro.Order)value$; break;
    case 1: reason = (io.seak.avro.OrderRejectReason)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public io.seak.avro.OrderRejectReason getReason() {
    return reason;
  }
   ...
   * @param value the value to set.
   */
  public void setReason(io.seak.avro.OrderRejectReason value) {
    this.reason = value;
  }
   ...
   */
  public static io.seak.avro.RejectedOrder.Builder newBuilder() {
    return new io.seak.avro.RejectedOrder.Builder();
  }
   ...
   * @return A new RejectedOrder RecordBuilder
   */
  public static io.seak.avro.RejectedOrder.Builder newBuilder(io.seak.avro.RejectedOrder.Builder other) {
    if (other == null) {
      return new io.seak.avro.RejectedOrder.Builder();
    } else {
      return new io.seak.avro.RejectedOrder.Builder(other);
    }
  }
   ...
   * @return A new RejectedOrder RecordBuilder
   */
  public static io.seak.avro.RejectedOrder.Builder newBuilder(io.seak.avro.RejectedOrder other) {
    if (other == null) {
      return new io.seak.avro.RejectedOrder.Builder();
    } else {
      return new io.seak.avro.RejectedOrder.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RejectedOrder>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.seak.avro.RejectedOrder.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.seak.avro.RejectedOrder other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.order)) {
        this.order = data().deepCopy(fields()[0].schema(), other.order);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.seak.avro.RejectedOrder.Builder setOrder(io.seak.avro.Order value) {
    ...
    public io.seak.avro.RejectedOrder.Builder setOrderBuilder(io.seak.avro.Order.Builder value) {
      clearOrder();
      orderBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public io.seak.avro.RejectedOrder.Builder clearOrder() {
      order = null;
      orderBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.seak.avro.RejectedOrder.Builder setReason(io.seak.avro.OrderRejectReason value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.seak.avro.RejectedOrder.Builder clearReason() {
      reason = null;
    ...
    public RejectedOrder build() {
      try {
        ...
        if (orderBuilder != null) {
          ...
          record.order = fieldSetFlags()[0] ? this.order : (io.seak.avro.Order) defaultValue(fields()[0]);
        }
        record.reason = fieldSetFlags()[1] ? this.reason : (io.seak.avro.OrderRejectReason) defaultValue(fields()[1]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.reason = io.seak.avro.OrderRejectReason.values()[in.readEnum()];
