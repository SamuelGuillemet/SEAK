...
public class Trade extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Trade(io.seak.avro.Order order, java.lang.CharSequence symbol, java.lang.Double price, java.lang.Integer quantity) {
    this.order = order;
    this.symbol = symbol;
    this.price = price;
   ...
   */
  public static io.seak.avro.Trade.Builder newBuilder() {
    return new io.seak.avro.Trade.Builder();
  }
   ...
   * @return A new Trade RecordBuilder
   */
  public static io.seak.avro.Trade.Builder newBuilder(io.seak.avro.Trade.Builder other) {
    if (other == null) {
      return new io.seak.avro.Trade.Builder();
    } else {
      return new io.seak.avro.Trade.Builder(other);
    }
  }
   ...
   * @return A new Trade RecordBuilder
   */
  public static io.seak.avro.Trade.Builder newBuilder(io.seak.avro.Trade other) {
    if (other == null) {
      return new io.seak.avro.Trade.Builder();
    } else {
      return new io.seak.avro.Trade.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Trade>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.seak.avro.Trade.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.seak.avro.Trade other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.order)) {
        this.order = data().deepCopy(fields()[0].schema(), other.order);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.seak.avro.Trade.Builder setOrder(io.seak.avro.Order value) {
    ...
    public io.seak.avro.Trade.Builder setOrderBuilder(io.seak.avro.Order.Builder value) {
      clearOrder();
      orderBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public io.seak.avro.Trade.Builder clearOrder() {
      order = null;
      orderBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.seak.avro.Trade.Builder setSymbol(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.seak.avro.Trade.Builder clearSymbol() {
      symbol = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.seak.avro.Trade.Builder setPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.seak.avro.Trade.Builder clearPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.seak.avro.Trade.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.seak.avro.Trade.Builder clearQuantity() {
